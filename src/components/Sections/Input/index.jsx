...
import AppContainer from "../../AppContainer";import {useEffect, useState} from "react";
            ...
            <div id="main-container">
                <div id="data-container">
                        ...
                        <div className="X-values">
                            <div id="X-first-row">
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x-5" value="-5"
                                           onChange={selectX} checked={xValue === (-5)}></input>
                                    <label className="radio-label" htmlFor="x-5">-5</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x-4" value="-4"
                                           onChange={selectX} checked={xValue === (-4)}></input>
                                    <label className="radio-label" htmlFor="x-4">-4</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x-3" value="-3"
                            ...
                            <div id="X-second-row">
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x-2" value="-2"
                                           onChange={selectX} checked={xValue === (-2)}></input>
                                    <label className="radio-label" htmlFor="x-2">-2</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x-1" value="-1"
                                           onChange={selectX} checked={xValue === (-1)}></input>
                                    <label className="radio-label" htmlFor="x-1">-1</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x0" value="0"
                            ...
                            <div id="X-third-row">
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x1" value="1"
                                           onChange={selectX} checked={xValue === (1)}></input>
                                    <label className="radio-label" htmlFor="x1">1</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x2"  value="2"
                                           onChange={selectX} checked={xValue === (2)}></input>
                                    <label className="radio-label" htmlFor="x2">2</label>
                                </div>
                                <div className="one-radio-container">
                                    <input type="checkbox" className="pointer radio-button" id="x3" value="3"
                                           onChange={selectX} checked={xValue === (3)}></input>
                    ...
                    <div id="Y">
                        Enter Y (-3; 3):
                        <br/>
                        <input className="pointer" type="text" id="Y-value" value={yValue} onInput={selectY}/>
                    </div>
                    <div id="R">
                        Choose R:
